...
{
    public partial class Int64Range : IConvertible
    {
        /// <inheritdoc/>
        ...
        /// <inheritdoc/>
        long IConvertible.ToInt64(IFormatProvider provider) => (long)(_Count + 1);
        ...
        object IConvertible.ToType(Type conversionType, IFormatProvider provider)
        {
            ...
            if (conversionType == typeof(Int32Range)) return (Int32Range)this;
        ...
        /// <inheritdoc/>
        uint IConvertible.ToUInt32(IFormatProvider provider) => (uint)(_Count + 1);
