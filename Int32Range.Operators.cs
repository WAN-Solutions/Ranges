...
namespace wan24.Ranges
{
    public partial class Int32Range
    {
        ...
        public static Int32Range operator +(Int32Range a, Int32Range b) => FromTo(Math.Min(a._FromIncluding, b._FromIncluding), Math.Max(a.ToIncluding, b.ToIncluding));
        ...
        /// <param name="b">Range 2</param>
        /// <returns>Range 1+2 matching new range</returns>
        public static Int64Range operator +(Int32Range a, Int64Range b) => Int64Range.FromTo(Math.Min(a._FromIncluding, b.FromIncluding), Math.Max(a.ToIncluding, b.ToIncluding));
        ...
        public static Int32Range operator +(Int32Range range, uint count)
        {
            if (range.IsReadonly) return new Int32Range(range._FromIncluding, range._Count + count);
            range.Count += count;
            return range;
        }
        ...
        /// <param name="range">Range</param>
        /// <returns>Updated range or new range (if readonly)</returns>
        public static Int32Range operator ++(Int32Range range) => range + 1;
        ...
        /// <returns>Updated range or new range (if readonly)</returns>
        public static Int32Range operator <<(Int32Range range, int count)
        {
            if (range.IsReadonly) return new Int32Range(range._FromIncluding - count, range._Count);
        ...
        public static Int32Range[] operator /(Int32Range range, int divisor)
        {
            ...
            Int32Range[] res = new Int32Range[count];
            int current = range._FromIncluding;
            for (
                uint i = 0, len, total = 0;
                i < count;
                res[i] = new Int32Range(current, len = (uint)Math.Min(divisor - 1, range._Count - divisor * i)), current += (int)len + 1, total -= len + 1, i++
                ) ;
            return res;
        }
        ...
        public static bool operator ==(Int32Range a, Int32Range b) => a.IsMatch(b);
        ...
        /// <param name="b">Range 2</param>
        /// <returns>Is match?</returns>
        public static bool operator ==(Int32Range a, Int64Range b) => a.IsMatch(b);
        ...
        /// <param name="b">Range 2</param>
        /// <returns>Is not match?</returns>
        public static bool operator !=(Int32Range a, Int64Range b) => !(a == b);
        ...
        public static bool operator ==(Int32Range range, int number) => range.IsMatch(number);
        ...
        public static bool operator !=(Int32Range range, int number) => !(range == number);
        ...
        public static bool operator <(Int32Range a, Int32Range b) => a._Count < b._Count;
        ...
        /// <param name="b">Range 2</param>
        /// <returns>Is smaller?</returns>
        public static bool operator <(Int32Range a, Int64Range b) => a._Count < b.Count;
        ...
        public static bool operator <(Int32Range range, int number) => range.ToIncluding < number;
        ...
        public static bool operator >(Int32Range range, int number) => range._FromIncluding > number;
